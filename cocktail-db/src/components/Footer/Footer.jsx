...
function Footer(props) {
	const onSubmitForm = (data) => {
		...
		emailjs
			.send(
				GmailService.SERVICE_ID,
				GmailService.TEMPLATE_ID,
				dataEmail,
				...
				(result) => {
					...
					toast.success(
						<div>
							...
							<p>Love you 3000 ♥</p>
							<p>Check your gmail to become our member</p>
						</div>
					);
				},
				(error) => {
					...
					toast.error(
						<div>
							<h4>Oops!!</h4>
							<p>Something error, pls try later</p>
						</div>
					);
				}
			);
	...
	return (
		<footer className="bg-gray-100 w-full pt-6 px-4 mt-32">
